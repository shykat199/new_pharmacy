...
{{--                                class="fa fa-plus-circle"></i> &nbsp; Create Invoice</a>--}}
                        <a href="{{auth()->user()->role == USER_ROLE ? route('user.create-invoice') : route('admin.create-invoice')}}" class="btn btn-primary btn-sm btn-icon-text"><i
                                class="fa fa-plus-circle"></i> &nbsp; Create Invoice</a>
                    </div>
                </div>
                <div class="card-body">
                    @livewire('admin.invoice-table', ['authUser' => Auth::user()])
                </div>
            </div>
        </div>
    </div>
                                                    ...
                                                    <tr>
                                                        <td style="width: 280px; position: relative;">
                                                            @if (!empty($row['product']))
                                                                <input class="form-control productInput" type="text" value="{{ $row['product'] }}" placeholder="Search products..." required readonly>
                                                            @else
                                                                <livewire:admin.invoice-produt-search wire:key="product-search-{{ $index }}" :index="$index" />
                                                            @endif
                                            ...
                                            <tbody id="table-body">
                                                @foreach ($rows as $index => $row)
                                                    <tr>
                                                        ...
                                                        {{--                                                    <button wire:click="addRow" type="button" class="btn btn-primary btn-xs" id="add-row-btn"><i class="fa-solid fa-plus-circle"></i></button> --}}
                                                        {{--                                                </td> --}}
                                                    </tr>
                                                @endforeach
                                            </tbody>
