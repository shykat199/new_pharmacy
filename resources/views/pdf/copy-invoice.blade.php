...
<div class="table-wrap">
    ...
    <div class="table-responsive" style="margin-top: 10px;">
        <table class="table-style" style="font-size: 20px;border-collapse: collapse; width: 100%;">
            ...
            <?php endforeach; ?>
                ...
                <tr>
                    <th colspan="6" style="text-align: right;">Total (TK)</th>
                    <th>{{ number_format($total, 2) }}</th>
                    <!--<th>{{ number_format($grandTotal, 2) }}</th>-->
                </tr>

                <tr>
                    <th colspan="6" style="text-align: right;">Other Charge (TK)</th>
                    <th>{{ number_format($otherCharge, 2) }}</th>
                </tr>
            <tr>
                <th colspan="6" style="text-align: right;">Grand Total (TK)</th>
                <th>{{ number_format($grandTotal, 2) }}</th>
            </tr>

                <tr>
                    <th colspan="6" style="text-align: right;">Paid Amount (TK)</th>
                    <th>{{ number_format($paidAmt, 2) }}</th>
                </tr>
                <tr>
                    <th colspan="6" style="text-align: right;">Due Amount (TK)</th>
